...
// Return the total number of page faults that have occurred since boot.
// The benchmark program calls this via the get_faults() user-space wrapper
// to measure how many faults each eviction policy causes over time.
int
sys_get_faults(void)
{
